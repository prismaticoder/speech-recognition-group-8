mfcc_features_file = 'dev_set_mfcc_features.mat';
output_hmm_file = 'dev_set_hmms.mat';
dataset_dir = 'dataset/development';

% Step 1: Extract MFCC features from the dataset
extract_mfcc_for_dataset(dataset_dir, mfcc_features_file);

% Step 2: Initialize HMMs with word-specific parameters
